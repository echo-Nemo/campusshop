$(function () {
    // 获取此店铺下的商品列表的URL
    var listUrl = '../product/getproductListbyshopid?pageIndex=1&pageSize=999';

    // 商品下架URL
    var statusUrl = '../product/modifyproduct';
    ...
    $('.product-wrap').on('click', 'a', function (e) {
        ...
        if (target.hasClass('edit')) {
            ...
            window.location.href = '../productadmin/productoperation?productId='
