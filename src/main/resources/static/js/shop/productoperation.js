$(function () {
    ...
    var infoUrl = '../product/getbyproductid?productId=' + productId;

    // 获取当前店铺设定的商品类别列表的URL
    var categoryUrl = '../product/queryproductcategorylist';
    ...
    function getCategory() {$.getJSON(categoryUrl, function (data) {
            if (data.status) {
