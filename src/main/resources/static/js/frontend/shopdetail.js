$(function () {
    ...
    // 列出商品列表的URL
    var listUrl = '../frontend/productlistbyshop';
    ...
    var searchDivUrl = '../frontend/listshopdetailspage?shopId=' + shopId;
    ...
    //給兑换奖品的a标签赋值兑换奖品的url
    $('#exchangelist').attr('href', '../frontend/shopawardlist?shopId=' + shopId);
