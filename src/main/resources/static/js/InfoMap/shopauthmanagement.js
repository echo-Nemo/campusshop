$(function () {
    ...
    // 列出该店铺下所有授权信息的URL
    var listUrl = '../shopmap/listshopauthmap?pageIndex=1&pageSize=9999';

    // 修改授权信息的URL
    var modifyUrl = '../shopmap/modifyshopauth';
    getList();
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    window.location.href = '../shopmap/modifyshopauth?shopAuthId='
