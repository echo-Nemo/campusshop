$(function () {
    ...
    function getList() {
        //listusershopmapbyshop
        // 获取用户购买信息URL
        var listUrl = '../product/listusershopmapbyshop?pageIndex=1&pageSize=9999&productName=' + productName;
    ...
    function getProductSellDailyList() {
        // 获取该店铺商品7天销量的URL listproductselldailybyshop
        var listProductSellDailyUrl = '../product/listproductselldailybyshop';
        // 访问后台，该店铺商品7天销量的URL
        $.getJSON(listProductSellDailyUrl, function (data) {
            ...
            if (data.status) {
                ...
                console.log("result = " + data.legendData);
