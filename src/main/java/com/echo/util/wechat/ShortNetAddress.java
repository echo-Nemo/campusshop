...
public class ShortNetAddress {
    //0320e75667b1c556431818cd3d673d19
    final static String CREATE_API = "https://dwz.cn/admin/v2/create";
    final static String TOKEN = "92b25a16acdcfdec93f28650f4e81f9f"; // TODO:设置Token
     ...
     * 失败：返回空字符串
     */
    public static String createShortU(String longUrl, String termOfValidity) {
    ...
    public static void main(String[] args) throws IOException {
        //设置long-term 长期有效
        //System.out.println(createShortUrl("https://mp.weixin.qq.com/debug/cgi-bin/sandbox?t=sandbox/login", "1-year"));
